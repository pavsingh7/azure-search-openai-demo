...
import { Send28Filled, RecordStop32Regular } from "@fluentui/react-icons";
        ...
        <Stack horizontal className={styles.questionInputContainer}>
            ...
            <div className={styles.questionInputButtonsContainer}>
                {isStreaming ? (
                    ...
                    //         />
                    //     </Tooltip>
                    <Button size="large" icon={<RecordStop32Regular primaryFill="#fab302" />} onClick={onStop} />
                ) : (
